...
**Family**: REQ-ODD-DOMAIN-MAPPING-CAP-*
**Status**: Active
**Category**: Capability

### REQ-ODD-DOMAIN-MAPPING-CAP-001 — Governed Mapping Over Published Domains
...
`odd_domain` SHALL support governed mapping work over published domain
...
### REQ-ODD-DOMAIN-MAPPING-CAP-002 — Durable Mapping Record Publication
...
`odd_domain` SHALL publish a durable machine-usable mapping record asset that
...
### REQ-ODD-DOMAIN-MAPPING-CAP-003 — Human Mapping Report Projection
...
`odd_domain` SHALL project a human-usable mapping report from the governed
...
### REQ-ODD-DOMAIN-MAPPING-CAP-004 — Categorized Mapping Semantics
...
`odd_domain` SHALL classify mappings by semantic correspondence category rather
...
### REQ-ODD-DOMAIN-MAPPING-CAP-005 — Confidence And Reasoning Disclosure
...
### REQ-ODD-DOMAIN-MAPPING-CAP-006 — Unassigned Surface Disclosure
...
### REQ-ODD-DOMAIN-MAPPING-CAP-007 — Real Published-Domain Proving Slice
