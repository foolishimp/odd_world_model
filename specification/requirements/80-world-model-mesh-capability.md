...
**Family**: REQ-ODD-DOMAIN-MESH-CAP-*
**Status**: Active
**Category**: Capability

### REQ-ODD-DOMAIN-MESH-CAP-001 — Federated Mesh Over Published Semantic Cuts
...
`odd_domain` SHALL support a federated world-model mesh built from published
semantic cuts rather than from one flattened central enterprise model.

### REQ-ODD-DOMAIN-MESH-CAP-002 — Lawful Mesh Participation
...
### REQ-ODD-DOMAIN-MESH-CAP-003 — Versioned Reference-Based Composition
...
### REQ-ODD-DOMAIN-MESH-CAP-004 — Cross-Domain Traversal
...
### REQ-ODD-DOMAIN-MESH-CAP-005 — Common-Model Reuse
...
### REQ-ODD-DOMAIN-MESH-CAP-006 — Incremental Mesh Growth
...
### REQ-ODD-DOMAIN-MESH-CAP-007 — Mesh-Aware Downstream Projection
...
`odd_domain` SHALL allow downstream projections such as query, mapping, proof,
