...
**Family**: REQ-ODD-DOMAIN-WORLD-OBJECT-*
**Status**: Active
**Category**: Capability

### REQ-ODD-DOMAIN-WORLD-OBJECT-001 — Prompt-Sufficient Object Representation

`odd_domain` SHALL represent each published world-model object with sufficient
...
### REQ-ODD-DOMAIN-WORLD-OBJECT-002 — Markov Blanket Explicitness

For every published Markov object, `odd_domain` SHALL make the object's
...
### REQ-ODD-DOMAIN-WORLD-OBJECT-003 — Cross-Domain Alignment Sufficiency

`odd_domain` SHALL represent world-model objects with enough context for a
...
### REQ-ODD-DOMAIN-WORLD-OBJECT-004 — Source Evidence Attachment
...
### REQ-ODD-DOMAIN-WORLD-OBJECT-005 — Treatment and Adjoint Traceability

When a world-model object participates in a downstream treatment or
cross-domain transformation, `odd_domain` SHALL attach the applicable
...
### REQ-ODD-DOMAIN-WORLD-OBJECT-006 — Conventional and Covariant Reuse
...
### REQ-ODD-DOMAIN-WORLD-OBJECT-007 — Fully Qualified Semantic Naming

`odd_domain` SHALL assign fully qualified identifiers to published semantic
...
### REQ-ODD-DOMAIN-WORLD-OBJECT-008 — Temporal Reference Artifact Modeling

When an attribute depends on a value list, code set, classification set, or
other governed reference semantics that can change over time, `odd_domain`
...
### REQ-ODD-DOMAIN-WORLD-OBJECT-009 — Attribute-Level Sourceability

`odd_domain` SHALL make every accepted world-model attribute claim recoverable
...
### REQ-ODD-DOMAIN-WORLD-OBJECT-010 — Qualified Multi-Surface Attribute Support

`odd_domain` SHALL support world-model attribute claims whose authority is
...
### REQ-ODD-DOMAIN-WORLD-OBJECT-011 — Attribute Ledger Materialization

`odd_domain` SHALL materialize accepted world-model attribute claims into an
...
### REQ-ODD-DOMAIN-WORLD-OBJECT-012 — Immutable Object-Cut Projection

`odd_domain` SHALL materialize each published Markov object as an immutable
