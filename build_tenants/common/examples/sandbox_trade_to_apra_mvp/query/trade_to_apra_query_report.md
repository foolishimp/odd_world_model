...
Trace chain:
- trace: `review://apra_liquidity/traces/reporting_position/counterparty_bucket/authority_claim.json` -> source: `input://apra_liquidity/authority_claims.json` @ `claims.counterparty_bucket_financial_institution`
- trace: `review://apra_liquidity/traces/reporting_position/counterparty_bucket/trade_counterparty.json` -> source: `review://parsed_trade_observation.json` @ `parties[0]`
...
- `inputs/apra_liquidity/authority_claims.json`
