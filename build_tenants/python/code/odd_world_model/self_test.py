...
"""Executive program runner derived from the current odd_world_model GTL carrier."""
...
from .app import OddWorldModelApp, start
...
def _program_converged(app: OddWorldModelApp, *, name: str) -> bool:
...
def run_program(app: OddWorldModelApp, *, name: str) -> dict[str, Any]:
    program = program_by_name(name)
