...
from odd_domain.build_line.fpml_trade_domain import OFFICIAL_SAMPLE_INPUT_REF
from odd_domain.build_line.trade_to_apra import build as build_trade_to_apra_sandbox
from odd_domain.build_line.trade_to_apra import sandbox_root
...
def _dbt_sql(bundle: dict[str, Any]) -> str:
    ...
    return f"""-- Generated from the governed odd_domain semantic kernel.
...
def _proof_summary(bundle: dict[str, Any], outputs: dict[str, Path]) -> dict[str, Any]:
    return {
        "proof_id": "odd_domain.proof.trade_to_apra.v1",
