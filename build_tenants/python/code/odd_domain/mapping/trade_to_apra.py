# Implements: REQ-ODD-DOMAIN-MAPPING-CAP-001
# Implements: REQ-ODD-DOMAIN-MAPPING-CAP-002
# Implements: REQ-ODD-DOMAIN-MAPPING-CAP-003
# Implements: REQ-ODD-DOMAIN-MAPPING-CAP-004
# Implements: REQ-ODD-DOMAIN-MAPPING-CAP-005
# Implements: REQ-ODD-DOMAIN-MAPPING-CAP-006
# Implements: REQ-ODD-DOMAIN-MAPPING-CAP-007
# Implements: REQ-ODD-DOMAIN-MAPPING-CONSTRAINT-001
# Implements: REQ-ODD-DOMAIN-MAPPING-CONSTRAINT-002
# Implements: REQ-ODD-DOMAIN-MAPPING-CONSTRAINT-003
# Implements: REQ-ODD-DOMAIN-MAPPING-CONSTRAINT-004
# Implements: REQ-ODD-DOMAIN-MAPPING-CONSTRAINT-005
# Implements: REQ-ODD-DOMAIN-MAPPING-CONSTRAINT-006
...
from odd_domain.build_line.trade_to_apra import materialize_composed_world_model_surface, sandbox_root
...
def build_analysis(*, reset: bool = True) -> dict[str, Any]:
    ...
    selected_mappings = [
        _mapping_entry(
            mapping_id="odd_domain.mapping.trade_to_apra.party_a_to_counterparty_bucket.v1",
        ...
        _mapping_entry(
            mapping_id="odd_domain.mapping.trade_to_apra.master_agreement_to_agreement_treatment_basis.v1",
        ...
        _mapping_entry(
            mapping_id="odd_domain.mapping.trade_to_apra.product_to_liquidity_bucket.v1",
    ...
    analysis = {
        "schema_kind": "odd_domain.mapping_analysis",
        "schema_version": "v1",
        "analysis_id": "odd_domain.mapping_analysis.trade_representation.to_apra_liquidity.trade_fpml_001.v1",
        ...
        "object_pairings": [
            {
                "pairing_id": "odd_domain.mapping_pair.trade_to_apra.primary_object_pair.v1",
...
def build_record(*, reset: bool = True) -> dict[str, Any]:
    ...
    record = {
        "schema_kind": "odd_domain.mapping_record",
        "schema_version": "v1",
        "mapping_record_id": "odd_domain.mapping_record.trade_representation.to_apra_liquidity.trade_fpml_001.v1",
