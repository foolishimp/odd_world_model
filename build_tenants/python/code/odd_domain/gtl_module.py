...
"""Published GTL module for the first live odd_domain carrier subset."""
...
_ROLE_CONSTRUCTOR = Role("odd_domain_constructor")
_builder = Operator(
    name="odd_domain_python_builder",
    regime=F_P,
    binding="odd_domain.python_tenant",
...
_trace_fd = _fd_evaluator("odd_domain_fd_trace_surface")
_assurance_fd = _fd_evaluator("odd_domain_fd_assurance_surface")
_attribute_ledger_fd = _fd_evaluator("odd_domain_fd_attribute_ledger_surface")
_markov_object_cut_fd = _fd_evaluator("odd_domain_fd_markov_object_cut_surface")
_published_domain_artifact_fd = _fd_evaluator("odd_domain_fd_published_domain_artifact_surface")
_composed_world_model_fd = _fd_evaluator("odd_domain_fd_composed_world_model_surface")
_query_projection_fd = _fd_evaluator("odd_domain_fd_query_projection_surface")
_mapping_analysis_fd = _fd_evaluator("odd_domain_fd_mapping_analysis_surface")
_mapping_record_fd = _fd_evaluator("odd_domain_fd_mapping_record_surface")
_mapping_report_fd = _fd_evaluator("odd_domain_fd_mapping_report_surface")
_constructor_fp = Evaluator(
    name="odd_domain_fp_semantic_constructor",
    regime=F_P,
    description="Primary constructive evaluator for the retained odd_domain GTL carrier.",
)
...
def _executive_graph_function(*, name: str, intent: str, functions: tuple[GraphFunction, ...]) -> GraphFunction:
    ...
    return GraphFunction.from_graph(
        ...
        tags=("odd_domain", "odd_method", "executive"),
    )
