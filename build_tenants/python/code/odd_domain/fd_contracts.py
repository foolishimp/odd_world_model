# Implements: REQ-ODD-DOMAIN-BUILD-CONSTRAINT-001
# Implements: REQ-ODD-DOMAIN-BUILD-VERIFY-001
"""Deterministic evaluator contracts for the retained odd_domain carrier slice."""
...
FD_EVALUATOR_CONTRACTS: dict[str, FdEvaluatorContract] = {
    "odd_domain_fd_source_observation": FdEvaluatorContract(
        evaluator_name="odd_domain_fd_source_observation",
    ...
    "odd_domain_fd_trace_surface": FdEvaluatorContract(
        evaluator_name="odd_domain_fd_trace_surface",
    ...
    "odd_domain_fd_assurance_surface": FdEvaluatorContract(
        evaluator_name="odd_domain_fd_assurance_surface",
    ...
    "odd_domain_fd_attribute_ledger_surface": FdEvaluatorContract(
        evaluator_name="odd_domain_fd_attribute_ledger_surface",
    ...
    "odd_domain_fd_markov_object_cut_surface": FdEvaluatorContract(
        evaluator_name="odd_domain_fd_markov_object_cut_surface",
    ...
    "odd_domain_fd_published_domain_artifact_surface": FdEvaluatorContract(
        evaluator_name="odd_domain_fd_published_domain_artifact_surface",
    ...
    "odd_domain_fd_composed_world_model_surface": FdEvaluatorContract(
        evaluator_name="odd_domain_fd_composed_world_model_surface",
    ...
    "odd_domain_fd_query_projection_surface": FdEvaluatorContract(
        evaluator_name="odd_domain_fd_query_projection_surface",
    ...
    "odd_domain_fd_mapping_analysis_surface": FdEvaluatorContract(
        evaluator_name="odd_domain_fd_mapping_analysis_surface",
    ...
    "odd_domain_fd_mapping_record_surface": FdEvaluatorContract(
        evaluator_name="odd_domain_fd_mapping_record_surface",
    ...
    "odd_domain_fd_mapping_report_surface": FdEvaluatorContract(
        evaluator_name="odd_domain_fd_mapping_report_surface",
...
def fd_binding(evaluator_name: str) -> str:
    return f"exec://python -m odd_domain.fd_checks {fd_cli_name(evaluator_name)} --workspace ."
