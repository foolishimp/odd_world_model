...
from odd_domain.world_model.registry import SCHEMA_FILE_NAMES, schemas_root
...
def validate_document(path: Path) -> ValidationResult:
    ...
    if schema_kind == "odd_domain.world_fragment":
        _require_keys(
            document,
            [
                "fragment_id",
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Validate odd_domain world-model carrier JSON files.")
