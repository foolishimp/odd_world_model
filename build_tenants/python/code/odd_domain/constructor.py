...
"""Local constructor for the retained odd_domain GTL carrier slice."""
...
def construct_manifest(manifest_path: str | Path, *, workspace_root: str | Path = ".") -> dict[str, Any]:
    ...
    evidence = (
        f"Rebuilt retained odd_domain steel thread and satisfied generated-asset contract "
        f"for {target_asset}"
    )
    payload = {
        "edge": manifest["edge"],
        "actor": "odd_domain_constructor",
