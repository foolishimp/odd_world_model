...
"""Named function catalog for the retained odd_domain GTL carrier subset."""
...
PROGRAM_CATALOG: tuple[ExecutiveProgramEntry, ...] = (
    ...
    ExecutiveProgramEntry(
        name="build_and_query_world_model",
        intent="Build, compose, and project the current odd_domain query surface from the retained source observation line.",
        steps=(
            "trace_source_observations",
            "assure_attribute_claims",
            "materialize_attribute_ledger",
