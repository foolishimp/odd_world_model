...
"""Asset semantics for the first live odd_domain ODD carrier slice."""
...
ASSET_TYPES = {
    "source_observation_surface": AssetTypeProfile(
        ...
        fd_evaluator="odd_domain_fd_source_observation",
    ...
    "trace_surface": AssetTypeProfile(
        ...
        semantic_facets=("traceability",),
        fd_evaluator="odd_domain_fd_trace_surface",
    ...
    "assurance_surface": AssetTypeProfile(
        ...
        fd_evaluator="odd_domain_fd_assurance_surface",
    ...
    "attribute_ledger_surface": AssetTypeProfile(
        ...
        fd_evaluator="odd_domain_fd_attribute_ledger_surface",
    ...
    "markov_object_cut_surface": AssetTypeProfile(
        ...
        fd_evaluator="odd_domain_fd_markov_object_cut_surface",
    ...
    "published_domain_artifact_surface": AssetTypeProfile(
        ...
        fd_evaluator="odd_domain_fd_published_domain_artifact_surface",
    ...
    "composed_world_model_surface": AssetTypeProfile(
        ...
        fd_evaluator="odd_domain_fd_composed_world_model_surface",
    ...
    "query_projection_surface": AssetTypeProfile(
        ...
        fd_evaluator="odd_domain_fd_query_projection_surface",
        fp_descriptive_framing="Filesystem-first query/report projection over retained odd_domain assets.",
        mutable_default=True,
    ...
    "mapping_analysis_surface": AssetTypeProfile(
        ...
        fd_evaluator="odd_domain_fd_mapping_analysis_surface",
    ...
    "mapping_record_surface": AssetTypeProfile(
        ...
        fd_evaluator="odd_domain_fd_mapping_record_surface",
    ...
    "mapping_report_surface": AssetTypeProfile(
        ...
        fd_evaluator="odd_domain_fd_mapping_report_surface",
