...
from odd_domain.build_line.fpml_trade_domain import example_root as fpml_example_root
        ...
        if relative.parts[:1] == ("objects",):
            ...
            if object_id == trade_object_id:
                ...
                boundary["adjacent_domains"] = sorted(
                    set(boundary.get("adjacent_domains", []) + ["odd_domain.domain.apra_liquidity.reporting.sandbox.v1"])
                )
                blanket = payload.setdefault("blanket", {})
                blanket["adjacent_domains"] = sorted(
                    set(blanket.get("adjacent_domains", []) + ["odd_domain.domain.apra_liquidity.reporting.sandbox.v1"])
                )
...
def _apra_ids(apra_input: dict[str, Any]) -> dict[str, str]:
    ...
    return {
        "fragment_id": "odd_domain.fragment.apra_liquidity.reporting.sandbox.v1",
        "domain_id": "odd_domain.domain.apra_liquidity.reporting.sandbox.v1",
        "reporting_position_id": (
            f"odd_domain.markov_object.apra_liquidity.reporting_position.{position['position_id']}"
        ),
        "counterparty_bucket_id": (
            f"odd_domain.world_model_object.apra_liquidity.counterparty_bucket.{position['counterparty_bucket']}"
        ),
        "agreement_basis_id": (
            "odd_domain.world_model_object.apra_liquidity.agreement_treatment_basis."
            f"{position['agreement_assessment']}"
        ),
        "treatment_id": "odd_domain.treatment.apra_liquidity.reporting_position.classification.v1",
        "local_covariance_id": (
            "odd_domain.covariance.apra_liquidity.reporting_position.to_counterparty_bucket.v1"
        ),
        "local_adjoint_id": (
            "odd_domain.adjoint.apra_liquidity.reporting_position.to_counterparty_bucket.v1"
        ),
        "cross_covariance_id": (
            "odd_domain.covariance.trade_representation.to_apra_liquidity.trade_fpml_001.v1"
        ),
...
def _apra_trace_id(position_id: str, claim_key: str, source_label: str) -> str:
    return f"odd_domain.trace.apra_liquidity.reporting_position.{position_id}.{claim_key}.{source_label}.v1"


def _apra_assurance_id(position_id: str, claim_key: str) -> str:
    return f"odd_domain.assurance.apra_liquidity.reporting_position.{position_id}.{claim_key}.v1"


def _apra_ledger_entry_id(position_id: str, claim_key: str) -> str:
    return f"odd_domain.attribute_ledger.apra_liquidity.reporting_position.{position_id}.{claim_key}.v1"
...
def _apra_fragment(
    ...
    return {
        ...
        "published_by": "odd_domain.project.sandbox_trade_to_apra_mvp",
        ...
        (
            "reporting_position.json",
            {
                ...
                "boundary": {
                    ...
                    "adjacent_domains": [
                        "odd_domain.domain.trade_representation.fpml_confirmation.v1"
                    ],
                },
                "blanket": {
                    "ingress_surfaces": [
    ...
    return [
        (
            "apra_liquidity_table.json",
            {
                ...
                "schema_version": "v1",
                "projection_id": "odd_domain.projection.apra_liquidity.table.v1",
        ...
        (
            "apra_liquidity_api_contract.json",
            {
                "schema_kind": "odd_domain.projection_spec",
                "schema_version": "v1",
                "projection_id": "odd_domain.projection.apra_liquidity.api_contract.v1",
        ...
        (
            "apra_liquidity_schema_contract.json",
            {
                "schema_kind": "odd_domain.projection_spec",
                "schema_version": "v1",
                "projection_id": "odd_domain.projection.apra_liquidity.schema_contract.v1",
...
def _apra_manifest(apra_input: dict[str, Any]) -> tuple[str, dict[str, Any]]:
    return (
        "apra_liquidity_manifest.json",
        {
            ...
            "schema_version": "v1",
            "manifest_id": "odd_domain.evidence.apra_liquidity.reporting.sandbox.v1",
...
def _apra_reference_artifacts(ids: dict[str, str]) -> list[tuple[str, dict[str, Any]]]:
    return [
        (
            ...
            {
                "schema_kind": "odd_domain.temporal_reference_artifact",
                "schema_version": "v1",
                "artifact_id": "odd_domain.reference_artifact.apra_liquidity.counterparty_bucket_set.v1",
                ...
                "usage": {
                    ...
                    "attribute_refs": [
                        "odd_domain.attribute.apra_liquidity.reporting_position.counterparty_bucket"
                    ],
                    "treatment_refs": [
                        ids["treatment_id"],
                        "odd_domain.treatment.trade_representation.to_apra_liquidity.candidate.v1"
    ...
    return [
        ...
        (
            "trade_to_apra_adjoint_candidate.json",
            {
                ...
                "forward_treatment_ref": "odd_domain.treatment.trade_representation.to_apra_liquidity.candidate.v1",
