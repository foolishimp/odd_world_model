...
# Implements: REQ-ODD-DOMAIN-BUILD-CAP-002
# Implements: REQ-ODD-DOMAIN-BUILD-CAP-003
# Implements: REQ-ODD-DOMAIN-BUILD-CAP-006
# Implements: REQ-ODD-DOMAIN-BUILD-CONSTRAINT-002
# Implements: REQ-ODD-DOMAIN-BUILD-CONSTRAINT-003
# Implements: REQ-ODD-DOMAIN-WORLD-OBJECT-004
# Implements: REQ-ODD-DOMAIN-WORLD-OBJECT-009
# Implements: REQ-ODD-DOMAIN-WORLD-OBJECT-010
# Implements: REQ-ODD-DOMAIN-WORLD-OBJECT-011
# Implements: REQ-ODD-DOMAIN-WORLD-OBJECT-012
...
from odd_domain.adapters.fpml_confirmation import parse_fpml_trade
from odd_domain.world_model.materialize import attribute_ledger_entry, assurance_record, trace_record
from odd_domain.world_model.registry import examples_root
...
def _party_object_id(xml_id: str) -> str:
    return f"odd_domain.world_model_object.trade_representation.party_profile.{xml_id}"


def _trade_markov_object_id() -> str:
    return "odd_domain.markov_object.trade_representation.trade_contract_state.trade_fpml_001"


def _source_trade_object_id() -> str:
    return "odd_domain.world_model_object.fpml_confirmation.trade_record.trade_fpml_001"


def _product_object_id() -> str:
    return "odd_domain.world_model_object.trade_representation.commodity_swap_product.product_fpml_001"


def _source_product_object_id() -> str:
    return "odd_domain.world_model_object.fpml_confirmation.commodity_swap_source.product_fpml_001"


def _agreement_object_id() -> str:
    return "odd_domain.world_model_object.trade_representation.master_agreement_reference.trade_fpml_001"
...
def _source_leg_object_id(leg_kind: str, index: int) -> str:
    return (
        "odd_domain.world_model_object.fpml_confirmation.commodity_swap_leg."
...
def _treatment_id() -> str:
    return "odd_domain.treatment.trade_representation.to_apra_liquidity.candidate.v1"


def _trade_trace_id(claim_key: str) -> str:
    return f"odd_domain.trace.trade_representation.trade_contract_state.trade_fpml_001.{claim_key}.v1"


def _trade_assurance_id(claim_key: str) -> str:
    return f"odd_domain.assurance.trade_representation.trade_contract_state.trade_fpml_001.{claim_key}.v1"


def _trade_ledger_entry_id(claim_key: str) -> str:
    return f"odd_domain.attribute_ledger.trade_representation.trade_contract_state.trade_fpml_001.{claim_key}.v1"
...
def _trade_fragment(observation: dict[str, Any]) -> dict[str, Any]:
    return {
        "schema_kind": "odd_domain.world_fragment",
        "schema_version": "v1",
        "fragment_id": "odd_domain.fragment.trade_representation.fpml_commodity_swap.v1",
        "bounded_context": "trade_representation.fpml_confirmation.commodity_swap",
        "published_at": PUBLISHED_AT,
        "published_by": "odd_domain.project.fpml_trade_representation_standard",
...
def _trade_objects(observation: dict[str, Any]) -> list[tuple[str, dict[str, Any]]]:
    ...
    objects: list[tuple[str, dict[str, Any]]] = [
        (
            ...
            {
                "schema_kind": "odd_domain.markov_object",
                "schema_version": "v1",
                ...
                "cross_domain": {
                    ...
                    "covariance_edge_refs": [
                        "odd_domain.covariance.trade_representation.trade_contract_to_product.v1"
                    ],
                    "adjoint_mapping_refs": [
                        "odd_domain.adjoint.trade_representation.trade_contract_to_product.v1"
                    ],
                    "loss_notes": [
        ...
        (
            ...
            {
                "schema_kind": "odd_domain.world_model_object",
                "schema_version": "v1",
...
def _source_fragment(observation: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        "schema_kind": "odd_domain.world_fragment",
        "schema_version": "v1",
        "fragment_id": "odd_domain.fragment.fpml_confirmation_source.commodity_swap.v1",
...
def _source_manifest() -> tuple[str, dict[str, Any]]:
    return (
        ...
        {
            "schema_kind": "odd_domain.evidence_manifest",
            "schema_version": "v1",
            "manifest_id": "odd_domain.evidence.fpml_confirmation_source.commodity_swap.v1",
...
def _trade_treatment() -> tuple[str, dict[str, Any]]:
    return (
        ...
        {
            "schema_kind": "odd_domain.treatment_surface",
            "schema_version": "v1",
            ...
            "target_domain": "odd_domain.domain.apra_liquidity.reporting.sandbox.v1",
            "preserved_structure": [
                "trade_identifier",
                "party_identity",
...
def _trade_edges() -> list[tuple[Path, dict[str, Any]]]:
    return [
        (
            ...
            {
                "schema_kind": "odd_domain.covariance_edge",
                "schema_version": "v1",
                "edge_id": "odd_domain.covariance.trade_representation.trade_contract_to_product.v1",
        ...
        (
            ...
            {
                "schema_kind": "odd_domain.adjoint_mapping",
                "schema_version": "v1",
                "mapping_id": "odd_domain.adjoint.trade_representation.trade_contract_to_product.v1",
                "forward_treatment_ref": _treatment_id(),
                "source_domain": "odd_domain.domain.trade_representation.fpml_confirmation.v1",
                "target_domain": "odd_domain.domain.trade_representation.fpml_confirmation.v1",
...
def _trade_projections() -> list[tuple[str, dict[str, Any]]]:
    ...
    return [
        (
            "trade_table.json",
            {
                "schema_kind": "odd_domain.projection_spec",
                "schema_version": "v1",
                "projection_id": "odd_domain.projection.trade_representation.table.v1",
        ...
        (
            "trade_api_contract.json",
            {
                "schema_kind": "odd_domain.projection_spec",
                "schema_version": "v1",
                "projection_id": "odd_domain.projection.trade_representation.api_contract.v1",
        ...
        (
            "trade_schema_contract.json",
            {
                "schema_kind": "odd_domain.projection_spec",
                "schema_version": "v1",
                "projection_id": "odd_domain.projection.trade_representation.schema_contract.v1",
...
def _trade_manifest() -> tuple[str, dict[str, Any]]:
    return (
        "fpml_trade_manifest.json",
        {
            "schema_kind": "odd_domain.evidence_manifest",
            "schema_version": "v1",
            "manifest_id": "odd_domain.evidence.trade_representation.fpml_trade_manifest.v1",
